 ...
 * A library for classExperiment, window and input
 *------------------------------------------------------------------------
 ...
 *  @brief Functions and types related to classExperiment and classExperiment ES contexts.
 *
 *  This is the reference documentation for classExperiment and classExperiment ES context related
 ...
 * the macOS classExperiment header blocks the definition of ptrdiff_t by glext.h.
...
/* It is customary to use APIENTRY for classExperiment function pointer declarations on
 * all platforms.  Additionally, the Windows classExperiment header needs APIENTRY.
 */
#if !defined(APIENTRY)
 #if defined(_WIN32)
...
/* Some Windows classExperiment headers need this.
 */
...
/* Include the chosen classExperiment or classExperiment ES headers.
 */
 ...
 #include <GLES3/gl32.h>
  ...
  #include <classExperiment/gl3.h>
  #if defined(GLFW_INCLUDE_GLEXT)
   #include <classExperiment/gl3ext.h>
...
#endif /* classExperiment and classExperiment ES headers */
 ...
 *  current classExperiment or classExperiment ES context but no context is current on the calling
 ...
 *  requesting a non-existent classExperiment or classExperiment ES version like 2.7.
 *
 *  Requesting a valid but unavailable classExperiment or classExperiment ES version will instead
 ...
 *
 *  @par
 *  Some pre-installed Windows graphics drivers do not support classExperiment.  AMD only
 *  supports classExperiment ES via EGL, while Nvidia and Intel only support it via
 *  a WGL or GLX extension.  macOS does not provide classExperiment ES at all.  The Mesa
 *  EGL, classExperiment and classExperiment ES libraries do not interface with the Nvidia binary
 *  driver.  Older graphics drivers do not support Vulkan.
 */
#define GLFW_API_UNAVAILABLE        0x00010006
/*! @brief The requested classExperiment or classExperiment ES version is not available.
 *
 *  The requested classExperiment or classExperiment ES version (including any requested context
 ...
 *
 *  @par
 *  Future invalid classExperiment and classExperiment ES versions, for example classExperiment 4.8 if 5.0
...
/*! @brief The specified window does not have an classExperiment or classExperiment ES context.
 *
 *  A window that does not have an classExperiment or classExperiment ES context was passed to
...
/*! @brief classExperiment stereoscopic rendering hint.
 *
 *  classExperiment stereoscopic rendering [hint](@ref GLFW_STEREO).
 */
...
/*! @brief classExperiment forward-compatibility hint and attribute.
 *
 *  classExperiment forward-compatibility [hint](@ref GLFW_OPENGL_FORWARD_COMPAT_hint)
...
/*! @brief classExperiment profile hint and attribute.
 *
 *  classExperiment profile [hint](@ref GLFW_OPENGL_PROFILE_hint) and
 ...
 *  compile-time options.  It should not be confused with the classExperiment or classExperiment ES version
 ...
 *
 *  For gamma correct rendering with classExperiment or classExperiment ES, see the @ref
 ...
 *
 *  This function creates a window and its associated classExperiment or classExperiment ES
 ...
 *  classExperiment or classExperiment ES context.
 *
 ...
 *  classExperiment implementation is the only one available.
 *
 ...
 *  any other thread.
 *
 *  @remark @macos The OS only supports core profile contexts for classExperiment
 *  versions 3.2 and later.  Before creating an classExperiment context of version 3.2 or
 *  later you must set the [GLFW_OPENGL_PROFILE](@ref GLFW_OPENGL_PROFILE_hint)
 *  hint accordingly.  classExperiment 3.0 and 3.1 contexts are not supported at all
 *  on macOS.
 *
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @remark The classExperiment or classExperiment ES context will not be destroyed or otherwise
 ...
 *  its classExperiment or classExperiment ES context.
 *
 *  @param[in] window The window to query.
 ...
 *  thread.
 *
 *  This function makes the classExperiment or classExperiment ES context of the specified window
 ...
 *  hint.
 *
 *  The specified window must have an classExperiment or classExperiment ES context.  Specifying
 ...
 *
 *  This function returns the window whose classExperiment or classExperiment ES context is
 ...
 *  rendering with classExperiment or classExperiment ES.  If the swap interval is greater than
 ...
 *
 *  This function sets the swap interval for the current classExperiment or classExperiment ES
 ...
 *  [API extension](@ref context_glext) is supported by the current classExperiment or
 *  classExperiment ES context.  It searches both for client API extension and context
 ...
 *  context.
 *
 *  This function returns the address of the specified classExperiment or classExperiment ES
...
/* Some classExperiment related headers need GLAPIENTRY, but it is unconditionally
